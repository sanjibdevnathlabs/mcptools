...
from .logging_config import setup_logging, generate_trace_id, set_trace_id
...
async def example_usage():
    ...
    logger.warning("WARNING_TRACE", {
        "issue": "non_critical_problem",
        "retry_count": 3
    })
